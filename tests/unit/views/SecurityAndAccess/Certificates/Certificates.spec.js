...
describe('Certificates.vue', () => {
  ...
  describe('formatSerialNumber()', () => {
    ...
    it('reformats an even-length pure-decimal hex string of length ≥ 4', () => {
      // '12345678' satisfies even + length ≥ 4 — formatted as octets
      expect(wrapper.vm.formatSerialNumber('12345678')).toBe('12:34:56:78');
    });
