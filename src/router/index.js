...
router.beforeEach((to, from, next) => {
  ...
  // condition will get statisfied if user refreshed from overview page
  ...
  } else if (currentUserRole && store.getters['authentication/isLoggedIn']) {
    // If role ID and CSRF token is available check and allow the navigation
