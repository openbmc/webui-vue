          ...
          <b-row>
            <b-col v-for="(dev, $index) in proxyDevices" :key="$index" md="6">
              ...
              <button-action
                ...
                @click:button-action="startVM(dev)"
              />
              <button-action
                v-if="dev.isActive"
                variant="primary"
                ...
                @click:button-action="stopVM(dev)"
              />
            </b-col>
          </b-row>
        </page-section>
            ...
            >
              ...
              >
                <button-action
                  ...
                  @click:button-action="configureConnection(device)"
                />
                <button-action
                  ...
                  :text="$t('pageVirtualMedia.start')"
                  @click:button-action="startLegacy(device)"
                />
                <button-action
                  v-if="device.isActive"
                  variant="primary"
                  class="float-right"
                  :text="$t('pageVirtualMedia.stop')"
                  @click:button-action="stopLegacy(device)"
                />
              </b-form-group>
            </b-col>
          </b-row>
