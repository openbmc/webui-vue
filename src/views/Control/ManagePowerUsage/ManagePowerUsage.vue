        ...
        <b-col sm="8" md="6" xl="3">
          ...
          >
            ...
            <b-form-invalid-feedback id="input-live-feedback" role="alert">
              ...
              <template v-else-if="!$v.powerCapValue.powerCapValueRange">
...
export default {
  ...
  validations: {
    powerCapValue: {
      powerCapValueRange(value) {
        return value === null || value === '' || (value >= 1 && value <= 10000);
      },
      required: requiredIf(function() {
        console.log('typeof powercap value', typeof this.powerCapValue);
        console.log(
          'typeof powercap',
          typeof this.powerCapValue === Object ||
            typeof this.powerCapValue === Number
        );
        return (
          typeof this.powerCapValue === Object ||
          typeof this.powerCapValue === Number
  ...
  methods: {
    submitForm() {
      console.log(this.$v);
      console.log(this.powerCapValue);
      this.$v.$touch();
