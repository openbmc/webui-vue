      ...
      <b-row>
        <b-col md="8">
          <b-form-group :label="$t('pageFactoryReset.page.resetOptionsLabel')">
            <b-form-radio-group
              id="factoryResetOptions"
              v-model="resetOptions"
              name="factoryResetOptions"
              stacked
            >
              <b-form-radio
                class="mb-1"
                value="resetBios"
                aria-describedby="resetBios"
                data-test-id="factoryReset-radio-resetBios"
              >
                {{ $t('pageFactoryReset.page.resetBiosOptionLabel') }}
              </b-form-radio>
              <b-form-text id="resetBios" class="ml-4 mb-3">
