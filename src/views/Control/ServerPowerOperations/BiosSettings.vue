<template>
  <div class="bios-form-background">
    <template v-for="(attriValue, key) of attributeValues">
      <b-form-group
        :key="key"
      ...
      >
        <b-form-select
          v-if="attriValue.length > 2 && key !== 'pvm_system_power_off_policy'"
        ...
        <template v-for="(values, keys) of attriValue">
          <b-form-radio
            v-if="
              attriValue.length <= 2 && key !== 'pvm_system_power_off_policy'
            "
            :key="values.value"
