...
export default {
  ...
  computed: {
    powerRestorePolicies() {
      return this.$store.getters['powerControl/powerRestorePolicies'];
    },
  ...
  created() {
    this.startLoader();
    Promise.all([
      this.$store.dispatch('powerControl/getPowerRestorePolicies'),
      this.$store.dispatch('powerControl/getPowerRestoreCurrentPolicy'),
