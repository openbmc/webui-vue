...
export const COUNTRY_LIST = [
  ...
  { name: 'Antigua and Barbuda', code: 'AG', label: i18n.global.t('countries.AG') },
  ...
  { name: 'Brunei Darussalam ', code: 'BN', label: i18n.global.t('countries.BN') },
  ...
  { name: 'Christmas Island ', code: 'CX', label: i18n.global.t('countries.CX') },
  { name: 'Cocos(Keeling) Islands', code: 'CC', label: i18n.global.t('countries.CC') },
  ...
  { name: 'Dominican Republic', code: 'DO', label: i18n.global.t('countries.DO') },
  ...
  { name: 'Equatorial Guinea ', code: 'GQ', label: i18n.global.t('countries.GQ') },
  ...
  { name: 'French Polynesia', code: 'PF', label: i18n.global.t('countries.PF') },
  {
  ...
  { name: 'Korea, Republic of', code: 'KR', label: i18n.global.t('countries.KR') },
  {
  ...
  { name: 'Marshall Islands', code: 'MH', label: i18n.global.t('countries.MH') },
  ...
  { name: 'Moldova, Republic of', code: 'MD', label: i18n.global.t('countries.MD') },
  ...
  { name: 'Papua New Guinea', code: 'PG', label: i18n.global.t('countries.PG') },
  ...
  { name: 'Russian Federation', code: 'RU', label: i18n.global.t('countries.RU') },
  { name: 'Rwanda', code: 'RW', label: i18n.global.t('countries.RW') },
  { name: 'Réunion', code: 'RE', label: i18n.global.t('countries.RE') },
  { name: 'Saint Barthélemy', code: 'BL', label: i18n.global.t('countries.BL') },
  {
    name: 'Saint Helena, Ascension and Tristan da Cunha',
    code: 'SH',
    label: i18n.global.t('countries.SH'),
  },
  { name: 'Saint Kitts and Nevis ', code: 'KN', label: i18n.global.t('countries.KN') },
  ...
  { name: 'Sao Tome and Principe', code: 'ST', label: i18n.global.t('countries.ST') },
  ...
  { name: 'Svalbard and Jan Mayen', code: 'SJ', label: i18n.global.t('countries.SJ') },
  { name: 'Sweden', code: 'SE', label: i18n.global.t('countries.SE') },
  { name: 'Switzerland', code: 'CH', label: i18n.global.t('countries.CH') },
  { name: 'Syrian Arab Republic', code: 'SY', label: i18n.global.t('countries.SY') },
  ...
  { name: 'Trinidad and Tobago', code: 'TT', label: i18n.global.t('countries.TT') },
  ...
  { name: 'United Arab Emirates', code: 'AE', label: i18n.global.t('countries.AE') },
  ...
  { name: 'Virgin Islands, U.S', code: 'VI', label: i18n.global.t('countries.VI') },
  { name: 'Wallis and Futuna', code: 'WF', label: i18n.global.t('countries.WF') },
