              ...
              <b-row>
                ...
                <b-col>
                  ...
                  <dl v-if="item.validUntil" class="d-flex mb-2">
                    <dt class="mr-2">{{ $t('pageCertificates.table.validUntil') }}:</dt>
                    <dd class="mb-0">
...
export default {
  ...
  mixins: [BVToastMixin, LoadingBarMixin, TableRowExpandMixin, DataFormatterMixin],
