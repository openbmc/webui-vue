...
export default {
  ...
  methods: {
    changeIpmiProtocolState(state) {
      ...
      let modalOptions;
      if (state) {
        modalMessage = this.$t('pageSecuritySettings.modal.enableMessage.ipmi');
        modalOptions = {
          title: this.$t('pageSecuritySettings.ipmi'),
          okTitle: this.$t('global.action.enable'),
          cancelTitle: this.$t('global.action.cancel'),
        };
      } else {
        modalMessage = this.$t(
          'pageSecuritySettings.modal.disableMessage.ipmi'
        );
        modalOptions = {
          title: this.$t('pageSecuritySettings.ipmi'),
          okTitle: this.$t('global.action.disable'),
          cancelTitle: this.$t('global.action.cancel'),
        };
      }
      this.$bvModal
        ...
        .then((confirmed) => {
          if (confirmed) {
            ...
            return (document.getElementById('ipmiSwitch').checked = !state);
          }
        });
    },
    changeSshProtocolState(state) {
      ...
      let modalOptions;
      if (state) {
        modalMessage = this.$t('pageSecuritySettings.modal.enableMessage.ssh');
        modalOptions = {
          title: this.$t('pageSecuritySettings.ssh'),
          okTitle: this.$t('global.action.enable'),
          cancelTitle: this.$t('global.action.cancel'),
        };
      } else {
        modalMessage = this.$t('pageSecuritySettings.modal.disableMessage.ssh');
        modalOptions = {
          title: this.$t('pageSecuritySettings.ssh'),
          okTitle: this.$t('global.action.disable'),
          cancelTitle: this.$t('global.action.cancel'),
      ...
      this.$bvModal
        ...
        .then((confirmed) => {
          if (confirmed) {
            ...
            return (document.getElementById('sshSwitch').checked = !state);
          }
        });
    },
  },
