            ...
            >
              <template v-slot:cell(Address)="{ item, index }">
                <b-form-input
                  ...
                  data-test-id="networkSettings-input-staticIpv4-${item.index}"
                  :aria-label="
              ...
              <template v-slot:cell(SubnetMask)="{ item, index }">
                <b-form-input
                  ...
                  data-test-id="networkSettings-input-subnetMask-${item.index}"
                  :aria-label="
              ...
              <template v-slot:cell(actions)="{ item, index }">
                <table-row-action
                  ...
                  :key="actionIndex"
                  data-test-id="networkSettings-button-deleteIpv4Row-${item.index}"
                  :value="action.value"
                  :title="action.title"
          ...
          <b-col lg="4" class="mb-3">
            ...
            >
              <template v-slot:cell(address)="{ item, index }">
                <b-form-input
                  v-model.trim="item.address"
                  data-test-id="networkSettings-input-dnsAddress-${item.index}"
                  :aria-label="
              ...
              <template v-slot:cell(actions)="{ item, index }">
                <table-row-action
                  v-for="(action, actionIndex) in item.actions"
                  :key="actionIndex"
                  data-test-id="networkSettings-button-deleteDnsRow-${item.index}"
                  :value="action.value"
                  :title="action.title"
