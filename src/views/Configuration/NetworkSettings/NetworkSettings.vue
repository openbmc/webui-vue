        ...
        <page-section :section-title="$t('pageNetworkSettings.ipv4')">
          <b-form-group :label="$t('pageNetworkSettings.ipv4Configuration')">
            <b-form-radio
              ...
              name="dhcp-radio"
              :value="true"
              :disabled="form.ipv4DhcpTableItems.length === 0"
...
export default {
  ...
  methods: {
    ...
    getIpv4StaticTableItems() {
      ...
      this.form.ipv4StaticTableItems = addresses
