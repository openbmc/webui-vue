      ...
      <b-col xl="8">
        <b-form-group :label="$t('pageFactoryReset.resetOptions')">
          <b-form-radio v-model="resetSettings" :value="true">
            {{ $t('pageFactoryReset.resetHostLabel') }}
          </b-form-radio>
          <p class="pl-4 form-text mt-1">
            {{ $t('pageFactoryReset.resetHostDescription') }}
          </p>
          <b-form-radio v-model="resetSettings" :value="false">
            {{ $t('pageFactoryReset.resetBmcAndHostLabel') }}
          </b-form-radio>
          <p class="pl-4 form-text mt-1">
            {{ $t('pageFactoryReset.resetBmcAndHostDescription') }}
          </p>
        </b-form-group>
      </b-col>
      <b-col xl="12">
