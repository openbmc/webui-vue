        ...
        <b-card>
          <template #header>
            <div class="d-md-flex justify-content-between align-items-center">
              ...
              >
                {{ $t('pageFactoryReset.continueWithReset') }}
              </b-button>
            </div>
          </template>
          <dl class="mb-0">
...
export default {
  name: 'FactoryReset',
  components: { Alert, PageTitle, ModalResetHypevisorSettings },
  ...
  computed: {
    get() {
      return this.$store.getters['factoryReset/getSystemStatusValue'];
    },
  },
  created() {
    this.startLoader();
    this.$store
      .dispatch('factoryReset/getSystemStatusValue')
