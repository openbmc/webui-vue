...
export default {
  ...
  computed: {
    ...
    attentionLedState: {
      get() {
        return this.systems.powerState === 'on';
      },
      set(state) {
        let stateValue = state === true ? 'on' : 'off';
        this.$store
          .dispatch('system/changeAttentionLedState', stateValue)
