  ...
  data() {
    return {
      ...
      timeZoneOptions: [
        ...
        {
          value: '-05:00',
          text: this.$t('pageDateTime.timeZone."BOGOTA_NEWYORK'),
        },
        {
          value: '-04:30',
        ...
        {
          value: '-02:00',
          text: this.$t('pageDateTime.timeZone.SAOPAULO_SOUTHGEORGIA'),
        },
        {
          value: '-01:00',
        ...
        {
          value: '+13:00',
          text: this.$t('pageDateTime.timeZone.AUCKLAND_FIJI_TONGATAPU'),
        },
      ],
    };
  },
