  ...
  <b-container fluid="xl">
    ...
    <b-row>
      <b-col xl="10" class="text-right">
        ...
        <b-button
          variant="link"
          data-test-id="eventSettings-init-modalSettingsSnmp"
          @click="initModalSettingsSnmp"
        >
          <icon-settings />
        ...
        <b-button
          variant="link"
          data-test-id="eventSettings-init-modalSettingsSmtp"
          @click="initModalSettingsSmtp"
        >
          <icon-settings />
...
import ModalSnmp from './ModalSnmp';
...
export default {
  ...
  created() {
    ...
    this.$store
      .dispatch('eventSettings/getSyslogData')
      .finally(() => this.endLoader());
  },
  methods: {
    initModalSettingsSmtp() {
      this.$root.$emit('resetFormSmtp');
      this.$bvModal.show('modal-smtp');
    },
    initModalSettingsSnmp() {
      this.$root.$emit('resetFormSnmp');
    ...
    sentTestMessage() {
      this.$store.dispatch('eventSettings/sentTestMessage');
    },
