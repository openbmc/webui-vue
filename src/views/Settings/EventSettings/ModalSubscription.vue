    ...
    >
      <b-form-group>
        <page-section>
          ...
          <b-row v-if="form.protocol === 'Syslog'">
            <b-col lg="6">
              <b-form-group>
                <b-form-radio-group v-model="form.syslogProtocol">
                  <b-form-radio
                    id="subscription-tcp"
...
export default {
  ...
  data() {
    return {
      ...
      protocols: [{ value: 'Syslog', text: 'Remote Syslog' }],
      protocolFormats: {
        SyslogTCP: 'tcp',
        SyslogUDP: 'udp',
      },
  ...
  methods: {
    ...
    submitForm() {
      ...
      let subscriptionForm = {
        protocol: this.form.syslogProtocol,
        destination:
