        ...
        >
          ...
          <template #head(checkbox)>
            <b-form-checkbox
              ...
              @change="handleChangeHeaderCheckbox(table, $event)"
            >
          ...
          <template #cell(checkbox)="row">
            <b-form-checkbox
              ...
              @change="handleToggleSelectRow(table, row.index)"
            >
              <span class="visually-hidden-focusable">
...
// Composables
const { dataFormatter, statusIcon } = useDataFormatter();
...
const allSensors = computed(() => sensorsStore.getSensors);
...
function handleRowSelected() {
  onRowSelected(table.value);
}

function handleToggleSelectRow(tableRef, rowIndex) {
  toggleSelectRow(tableRef, rowIndex, handleRowSelected);
}

function handleChangeHeaderCheckbox(tableRef, event) {
  // tableRef is already the actual table element from template
