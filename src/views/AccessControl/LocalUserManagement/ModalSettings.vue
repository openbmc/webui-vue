...
export default {
  ...
  data() {
    return {
      form: {
        lockoutThreshold: this.settings.lockoutThreshold,
        unlockMethod: this.settings.lockoutDuration > 1 ? 1 : 0,
        lockoutDuration: this.settings.lockoutDuration
  ...
  watch: {
    settings: function({ lockoutThreshold, lockoutDuration }) {
      ...
      this.form.unlockMethod = lockoutDuration > 1 ? 1 : 0;
  ...
  methods: {
    ...
    resetForm() {
      ...
      this.form.unlockMethod = this.settings.lockoutDuration > 1 ? 1 : 0;
