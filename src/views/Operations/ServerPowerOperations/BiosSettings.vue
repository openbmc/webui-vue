              ...
              <template v-if="key === 'pvm_system_operating_mode'">
                <b-row :key="keys">
                  ...
                  <template v-if="keys === 1">
                    ...
                    <b-col
                      v-else-if="currentOperatingMode === 'Manual'"
                      class="section-left-divider"
                    >
                      <alert
                        :key="`${values.value}3`"
  ...
  computed: {
    ...
    automaticRetryConfig: {
      get() {
        console.log(
          'config value',
          this.$store.getters['serverBootSettings/automaticRetryConfigValue']
        );
        return (
          this.$store.getters[
  ...
  methods: {
    onChangeSystemOpsMode(value) {
      ...
      if (
        ...
        console.log('inside manual setting');
        this.$store.commit(
          'serverBootSettings/setAutomaticRetryConfigValue',
          'Disabled'
        );
