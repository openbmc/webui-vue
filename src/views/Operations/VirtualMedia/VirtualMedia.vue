...
console.log('import.meta.env.VITE_APP_VIRTUAL_MEDIA_LIST_ENABLED', import.meta.env.VITE_APP_VIRTUAL_MEDIA_LIST_ENABLED);
...
const stopLegacy = (connectionData) => {
  virtualMediaStore.unmountImage(connectionData.id)
    .then(() => {
      // this.successToast(
