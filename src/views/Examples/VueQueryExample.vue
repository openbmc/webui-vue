          ...
          <dd class="col-sm-8">
            <div class="d-flex align-items-center gap-2">
              ...
              <b-button
                size="sm"
                variant="primary"
                :disabled="isPatchPending || lockoutThreshold === data.AccountLockoutThreshold"
...
const patchMutation = usePatchAccountService();
...
const patchMutation = usePatchAccountService();
const isPatchPending = patchMutation.isPending;
