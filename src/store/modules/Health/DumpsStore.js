  ...
  actions: {
    ...
    async createResourceDump() {
      return await api
        ...
        .then(() =>
          i18n.t('pageDumps.toast.successStartResourceDump', {
            title: i18n.t('pageDumps.toast.successStartResourceDumpTitle'),
            timestamp: true,
          })
        )
        .catch((error) => {
          console.log(error);
          const message = i18n.t('pageDumps.toast.errorStartResourceDump', {
            title: i18n.t('pageDumps.toast.errorStartResourceDumpTitle'),
            timestamp: false,
          });
