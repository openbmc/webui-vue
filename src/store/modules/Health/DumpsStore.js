  ...
  actions: {
    ...
    async createBmcDump() {
      return await api
        ...
        .then(() => i18n.t('pageDumps.toast.successStartBmcDump'))
        .catch((error) => {
          console.log(error);
    ...
    async createSystemDump() {
      return await api
        ...
        .then(() => i18n.t('pageDumps.toast.successStartSystemDump'))
        .catch((error) => {
          console.log(error);
    ...
    async downloadDump(_, location) {
      return await api
        .get(location)
        .then(() => i18n.t('pageDumps.toast.successStartDownloadDump'))
        .catch((error) => {
          console.log(error);
          throw new Error(i18n.t('pageDumps.toast.errorDownloadDump'));
        });
    },
  },
};
