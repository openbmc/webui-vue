...
const PowerControlStore = {
  ...
  getters: {
    ...
    powerPoliciesData: (state) => state.powerPoliciesData,
  },
  mutations: {
    ...
    setPowerPoliciesData: (state, powerPoliciesData) =>
      (state.powerPoliciesData = powerPoliciesData),
  },
  actions: {
      ...
      return await api
        ...
        .then(
          ({
            ...
            let powerPoliciesData = PowerRestorePolicyTypes?.PowerRestorePolicyTypes.enum.map(
              (powerState) => {
                return {
                  state: powerState,
            ...
            commit('setPowerPoliciesData', powerPoliciesData);
          }
        );
    },
