...
/**
 * Active Redfish sessions.
 *
 * Mirrors the master-branch fetch pattern: GET the collection index with no
 * query parameters, then GET each member individually by its @odata.id.
 * OpenBMC does not support $expand on the Sessions collection.
 */
