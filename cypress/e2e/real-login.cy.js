// NOTE: Before running tests, copy cypress.env.json.example to cypress.env.json
//       and set your BMC username and password.
...
describe('BMC Login Test', () => {
  it('should login successfully', () => {
    ...
    cy.contains('Overview', { timeout: Cypress.env('loginTimeout') }).should('be.visible');
  });
});

// Time Travel: In Cypress UI, click any step to see DOM state at that moment
...
// Auto Screenshot: Take screenshots at any step, auto screenshot on failure
...
// Session Caching: Login once, reuse session for multiple tests
...
// Network Intercept: Intercept and mock API responses
describe('Network Intercept Demo', () => {
  ...
  it('mock Redfish API with fixture', () => {
    // Example: Use redfish-mock.json to mock API response
    cy.intercept('GET', '**/redfish/v1/', { fixture: 'redfish-mock.json' }).as(
      'redfishRoot',
    );
...
// Auto Wait: Cypress auto waits for elements, auto retries assertions
...
// Element Interactions: Simulate various user actions
